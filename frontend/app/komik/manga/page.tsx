...
export default function MangaPage() {
  ...
  const fetchComics = useCallback(async (page: number) => {
    const response = await komikApi.getManga(page);
    return {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="mb-6">
        <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">Manga</h1>
        <p className="text-gray-400 mb-4">Koleksi manga Jepang dengan terjemahan Indonesia</p>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        ...
        <Link href="/komik/manga" className="px-4 py-2 bg-primary text-white rounded-lg font-medium">
          Manga
        </Link>
        ...
        <>
          ...
          <div ref={sentinelRef} className="py-8 flex justify-center">
            ...
            {!hasNext && comics.length > 0 && (
              <p className="text-gray-500 text-sm">Sudah menampilkan semua manga</p>
            )}
          </div>
        </>
      )}
